  ...
  return (
    <div className="min-h-screen bg-[#0C0A09] flex flex-col items-center justify-center px-6 text-center">
      ...
      <div className="relative z-10 max-w-lg">
        ...
        <p className="text-[#A16207] tracking-[0.4em] text-xs uppercase mb-4 opacity-70">Page Not Found</p>
        <h1 className="font-['Great_Vibes'] text-8xl text-[#FAFAF9] opacity-15 mb-4">404</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/" className="px-10 py-4 bg-[#A16207] text-[#0C0A09] text-sm tracking-[0.2em] uppercase font-semibold hover:bg-[#FAFAF9] transition-all duration-500">
            Go Home
          </Link>
          <Link href="/builder" className="px-10 py-4 border border-[#A16207] border-opacity-30 text-[#A16207] text-sm tracking-[0.2em] uppercase hover:bg-[#A16207] hover:text-[#0C0A09] transition-all duration-500">
            Create an Invite
          </Link>
        </div>
